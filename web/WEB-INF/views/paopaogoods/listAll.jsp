...
<script type="text/javascript">
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=/paopaogoods/listsgoods&page=" + _index + "&size=" + size + "&_t=" + new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "#module=/paopaogoods/listsgoods&page=" + page + "&size=" + size + "&_t=" + new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
    ...
    function deletePaopaoGoods(_id) {
        ...
        $.ajax({
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    alert("删除成功");
                    window.location.href = "#module=/paopaogoods/listsgoods&page="+${page.page}+
                    "&_t=" + new Date().getTime();
                } else {
                    var _case = {1: "删除失败"};
