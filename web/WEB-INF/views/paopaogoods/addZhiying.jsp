                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <c:forEach items="${listSh}" var="e">
                            <div class="col-sm-2">
                                <input type="checkbox" value="${e.empId}|${e.schoolId}"
                                       name="listSh">${e.empName} ${e.schoolName}
                            </div>
                        </c:forEach>
                    </div>
        ...
        $.ajax({
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    ...
                    if (str == null || str == '') {
                        alert("添加成功");
                        window.location.href = "#module=/paopaogoods/listZhiying&page=1"+ "&_t="+ new Date().getTime();
                    } else {
