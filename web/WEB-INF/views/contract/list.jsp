                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" type="button" onclick="changeContract('${e.empId}')">
                                    设置
                                </button>
                                <button class="btn btn-primary" type="button" onclick="selectPermission('${e.empId}')">
                                    分配权限
                                </button>
                            </td>
                        </tr>
...
<script type="text/javascript">
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=listContracts&page=" + _index + "&size=" + size + "&_t=" + new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "#module=listContracts&page=" + page + "&size=" + size + "&_t=" + new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
