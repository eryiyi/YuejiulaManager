      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="mm_ad_title" value="${adObj.mm_ad_title}" class="form-control" placeholder="广告语" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
...
<script type="text/javascript">
  function saveP(){
    ...
    $.ajax({
      ...
      type: "POST",
      url:"/adObj/editAd.do",
      data:{"mm_ad_pic":imagePath, "mm_ad_url":mm_ad_url,"mm_ad_num":mm_ad_num,"mm_ad_id":mm_ad_id,"mm_ad_title":mm_ad_title},
      async: false,
