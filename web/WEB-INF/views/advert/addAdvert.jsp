      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" role="form">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select class="populate placeholder" name="university" id="s2_province" onchange="selectCollege()">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" id="ad_net" class="form-control" placeholder="链接网址" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
...
//                  var imageDivHtml = $("#imageDiv").html() + html;
  ...
  function saveAdvert(){
    ...
    $.ajax({
      ...
      type: "POST",
      url:"/addAdvert.do",
      data:{"adSchoolId":schoolId, "adIsUse":isUse, "adTypeId":isBigImage, "adUrl":adUrl, "endTime":endTime, "adPic":imagePath },// 你的formid
      async: false,
