                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="toggle-switch toggle-switch-success">
                                <label>
                                    <input id="isBigImage" name="isUse"
                                           type="checkbox" ${advert.adTypeId=='1'?'checked':''} >
                            ...
                            <div class="toggle-switch toggle-switch-success">
                                <label>
                                    <input id="isUse" name="isUse"
                                           type="checkbox" ${advert.adIsUse=='1'?'checked':''}  >
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-2">
                            <input type="text" id="input_date" class="form-control" placeholder="Date"
                                   value="${um:format(advert.endTime, "MM/dd/yyyy" )}">
...
//                    var imageDivHtml = $("#imageDiv").html() + html;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="ad_net" value="${advert.adUrl}" class="form-control"
                                   placeholder="链接网址" data-toggle="tooltip" data-placement="bottom"
