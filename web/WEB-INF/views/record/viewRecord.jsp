...
<head>
    ...
    <style>
        * {
        ...
        .comment dd .right .top {
            line-height: 200%;
            font-size: .9rem;
            color: #969696;
        }

        .comment dd .right .top .name {
            float: left;
        }

        .comment dd .right .top .floor {
            float: right;
        }

        .comment dd .right .top .crap {
            font-size: 1rem;
            display: block;
            line-height: 150%;
            color: #444444;
        ...
        .title-divider {
            ...
            padding: 5px 0;
            border-radius: 3px;
            background-color: #39C4FB;
            color: #fff;
            font-weight: normal;
        }

        .recommends .recommends-content .recommends-item {
            border-radius: 3px;
            display: block;
            width: 95%;
            margin: 0 auto 1rem;
        ...
        .recommends .recommends-content .recommends-item .img-holder {
            height: 6rem;
            width: 25%;
            float: left;
            overflow: hidden;
        ...
        .recommends .recommends-content .recommends-item .img-holder img {
            display: block;
            width: 150%;
        }

        .recommends .recommends-content .recommends-item p {
            overflow: auto;
            height: 6rem;
            width: 75%;
            display: block;
