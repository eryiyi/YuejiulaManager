                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>${e.dateLine}</td>
                            <td>
                                <button class="btn btn-primary" type="button" onclick="deleteCollege('${e.recordId}')">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script type="text/javascript">
    function deleteCollege(id){
        ...
        $.ajax({
            ...
            success: function(_data) {
                ...
                if(data.success){
                    alert("删除成功！");
                    window.location.href="#module=/schoolRecordsController/list.do&page=1"+"&size=10";
                }else{
                    var _case = {1:"删除失败"};
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href="#module=/schoolRecordsController/list.do&page="+page+"&size="+size;
        } else {
    ...
    function searchIndex(e){
        ...
        if(_index <= ${page.pageCount} && _index >= 1){
            window.location.href="#module=/schoolRecordsController/list.do&page="+_index+"&size="+size;
        }else{
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
