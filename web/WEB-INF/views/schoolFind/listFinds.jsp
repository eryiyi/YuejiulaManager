...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void (0);">发现网址列表</a></li>
        </ol>
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>${e.www_url}</td>
                            <td>
                                <button class="btn btn-primary" type="button" onclick="deleteNews('${e.school_find_id}')">删除</button>
...
<script type="text/javascript">
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href="#module=listSchoolFind&page="+page+"&size="+size;
        } else {
    ...
    function searchIndex(e){
        ...
        if(_index <= ${page.pageCount} && _index >= 1){
            window.location.href="#module=listSchoolFind&page="+_index+"&size="+size;
        }else{
            alert("请输入1-${page.pageCount}的页码数");
        }
    }

    function deleteNews(school_find_id){
        if(!confirm("确定要删除该网址么？")){
            return;
        }
        $.ajax({
            type:"post",
            data:{"school_find_id": school_find_id},
            url:"/deleteFinds.do",
