            ...
            <div class="box-content">
                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="ruleName" name="ruleName" class="form-control" placeholder="类型名称"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="ruleType" name="ruleType" class="form-control" placeholder="类型"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="ruleScore" name="ruleScore" class="form-control" placeholder="分数"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
