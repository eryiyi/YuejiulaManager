...
<div class="row">
  <div id="breadcrumb" class="col-xs-12">
    ...
    <ol class="breadcrumb pull-left">
      ...
      <li><a href="javaScript:void(0)">添加类别</a></li>
    </ol>
...
//                  var imageDivHtml = $("#imageDiv").html() + html;
  ...
  function save(){
    ...
    $.ajax({
      cache: true,
      type: "POST",
      url:"/savePartTimeType.do",
      data:{"name":name, "cover":imagePath},// 你的formid
      async: false,
      success: function(_data) {
        ...
        if(data.success){
          ...
          var _case = {1:"类别名称不能为空", 2:"请上传类别图片", 3:"添加失败"};
