...
<div class="row">
  <div id="breadcrumb" class="col-xs-12">
    ...
    <ol class="breadcrumb pull-left">
      ...
      <li><a href="javascript:void (0);">注册环信学校</a></li>
    </ol>
  ...
  <div class="col-xs-12 col-sm-12">
    <div class="box ui-draggable ui-droppable">
      ...
      <div class="box-content">
        ...
        <h4 class="page-header">注册环信学校</h4>
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          <div class="form-group">
            <label class="col-sm-2 control-label">学校名字</label>
            <div class="col-sm-4">
              <input type="text" id="name"  name="name" class="form-control" placeholder="学校名字" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
