      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="populate placeholder" name="school_three_pingtai_id" id="school_three_pingtai_id">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="pingtai_url" name="school_three_pingtai_name" class="form-control" placeholder="平台链接" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
