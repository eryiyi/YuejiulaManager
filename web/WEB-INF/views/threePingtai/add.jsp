      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="school_three_pingtai_name" name="school_three_pingtai_name" class="form-control" placeholder="平台标题" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
            <div class="form-group">
