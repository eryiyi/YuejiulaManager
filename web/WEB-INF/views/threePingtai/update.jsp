    ...
    <div class="box">
      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
            <input type="hidden" id="school_three_pingtai_id" name="school_three_pingtai_id" value="${schoolThreeTingtai.school_three_pingtai_id}">
            <input type="hidden" id="school_three_pingtai_pic" name="school_three_pingtai_pic" value="${schoolThreeTingtai.school_three_pingtai_pic}">

          <div class="form-group">
            <label class="col-sm-2 control-label">平台标题</label>
            <div class="col-sm-4">
              <input type="text" id="school_three_pingtai_name" value="${schoolThreeTingtai.school_three_pingtai_name}" name="school_three_pingtai_name" class="form-control" placeholder="平台标题" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" >平台图标</label>
                <div class="col-sm-10 col-md-2">
                    <img class="img-thumbnail" name="imagePath" id="imageDiv"   style="cursor: pointer"  src="${schoolThreeTingtai.school_three_pingtai_pic}"/>
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    ...
    function save(){
        ...
        $.ajax({
            ...
            data:{"school_three_pingtai_id":school_three_pingtai_id, "school_three_pingtai_name":school_three_pingtai_name, "school_three_pingtai_pic":imagePath},
            async: false,
