      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="emp_pingtai_mng_id" name="emp_pingtai_mng_id" value="${schoolThreeTingtai.emp_pingtai_mng_id}">
                <div class="col-sm-4">
                    <select class="populate placeholder" name="school_three_pingtai_id" id="school_three_pingtai_id" disabled="disabled">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="pingtai_url" name="school_three_pingtai_name" value="${schoolThreeTingtai.pingtai_url}" class="form-control" placeholder="平台链接" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
...
<script type="text/javascript">
    function save(){
        ...
        $.ajax({
            ...
            data:{"emp_pingtai_mng_id":emp_pingtai_mng_id, "school_three_pingtai_id":school_three_pingtai_id, "pingtai_url":pingtai_url},
            async: false,
