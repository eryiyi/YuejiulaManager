        ...
        <table class="table">
          ...
          <c:forEach items="${list}" var="e" varStatus="st">
            <tr>
              ...
              <td>${e.pingtai_url}</td>
              <td>
                <button class="btn btn-info" type="button" onclick="toUpdate('${e.emp_pingtai_mng_id}')">修改</button>
                <button class="btn btn-primary" type="button" onclick="deleteUniversity('${e.emp_pingtai_mng_id}')">删除</button>
              </td>
            </tr>
          </c:forEach>
          </tbody>
