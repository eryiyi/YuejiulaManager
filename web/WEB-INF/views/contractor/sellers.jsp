                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-default btn-sm"
                                   href="#module=/toSellerGoodsSetting&empId=${e.empId}&schoolId=${e.schoolId}"
                                   role="button">设置</a>
                                <button class="btn btn-primary" type="button"
                                        onclick="deleteSeller('${e.empId}','${e.contractId}')">删除
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
...
<script type="text/javascript">
    ...
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=listSeller&page=" + _index + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "#module=listSeller&page=" + page + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
