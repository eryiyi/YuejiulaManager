...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        ...
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="javascript:void (0);">校园新闻</a></li>
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/viewNews.do?newsId=${e.id}&publishType=0" target="_blank">查看</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script type="text/javascript">
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1)) {
            window.location.href = "#module=listNews&page=" + page + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
    ...
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=listNews&page=" + _index + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
