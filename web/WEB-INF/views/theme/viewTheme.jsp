...
<head>
    ...
    <style>
        * {
        ...
        .container .detail .time h5 i.green {
            color: #5cb85c;
        }

        .container .detail .time h5 i.orange {
            color: #f0ad4e;
        }

        .container .detail .topic, .container .detail .brief {
            display: table;
            width: 90%;
            margin: 0 auto 1rem;
        }

        .container .detail .topic .name, .container .detail .brief .name {
            white-space: nowrap;
            display: table-cell;
            font-style: normal;
            font-size: 1.1rem;
        ...
        .container .detail .topic .content, .container .detail .brief .content {
            display: table-cell;
            font-size: .9rem;
            color: #666666;
            line-height: 150%;
        ...
        .container .rewards:hover {
            border-color: #f0ad4e;
        }

        .container .rewards legend {
            font-size: 1.6rem;
            color: #f0ad4e;
            text-align: center;
        }

        .container .rewards .each {
            width: 90%;
            margin: 2rem auto;
        }

        .container .rewards .each .area {
            font-size: 1.3rem;
            padding: .5rem 0;
            text-align: center;
        ...
        .container .rewards .each .content {
            color: #666666;
            margin: 0 auto;
        }

        .container .rewards .each .content p {
            padding: 1rem 0;
        }

        .container .rewards .each .content img {
            display: block;
            width: 100%;
            padding: 3px;
            border-radius: 2px;
