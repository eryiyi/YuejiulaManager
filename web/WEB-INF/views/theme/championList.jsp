                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${e.isPic == '1'}">
                                    <a href="javascript:void (0);"><img class="img-rounded" width="50" height="50"
                                                                        src="${e.uploadPic}"
                                                                        onclick="ImgShow(event)"></a>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${e.isPic == '0'}">
                                    <button class="btn btn-primary" type="button" onclick="uploadPic('${e.id}')">传照片
                                    </button>
                                </c:if>
                            </td>
                        </tr>
