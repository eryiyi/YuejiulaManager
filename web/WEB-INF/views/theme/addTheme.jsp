            ...
            <div class="box-content">
                ...
                <form id="save_form" class="form-horizontal" method="post" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="theme_title" class="form-control" placeholder="活动主题"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="theme_number" class="form-control" placeholder="活动期次"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="theme_mudi" class="form-control" placeholder="活动目的"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="theme_content" class="form-control" placeholder="活动介绍"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
                    <div class="form-group">
