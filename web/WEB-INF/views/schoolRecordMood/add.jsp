      ...
      <div class="box-content">
        ...
        <form id="save_form" class="form-horizontal" method="post" role="form" >
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" id="school_record_mood_name"  name="school_record_mood_name" class="form-control" placeholder="心情标签" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">心情标签</label>
            <div class="col-sm-4">
              <input type="text" id="top_num"  name="top_num" class="form-control" value="0" placeholder="置顶数字，越大越靠前" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
            </div>
          </div>
