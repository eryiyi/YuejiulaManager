package com.liangxunwang.unimanager.baidu.baidu.utility;
            ...
            try {
                ...
                if (field.isAnnotationPresent(JSonPath.class)) {
                    ...
                    if (zlass.equals(Long.class)
                                    ...
                                    if (isGenericClassMap(jsonObj)) {
                                        for (Object o : (List) jsonObj) {
                                            ...
                                            Object targetOject = ((Class) types[0])
                                                    .newInstance();
                                            com.liangxunwang.unimanager.baidu.utility.MapObjectUtility
                        ...
                        com.liangxunwang.unimanager.baidu.utility.MapObjectUtility.convertMap2ObjectWithJson(targetOject,
                                m);
