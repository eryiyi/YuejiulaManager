package com.liangxunwang.unimanager.baidu.baidu.httpclient;
...
public class YunHttpClient implements YunHttpObservable {
    ...
    private static Logger logger = Logger.getLogger(com.liangxunwang.unimanager.baidu.httpclient.YunHttpClient.class
            .getName());
