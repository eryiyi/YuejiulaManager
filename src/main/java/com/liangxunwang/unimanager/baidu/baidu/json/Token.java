...
public class Token implements java.io.Serializable {
     ...
     */
    public com.liangxunwang.unimanager.baidu.json.Token next;
     ...
     * field is null.
     */
    public com.liangxunwang.unimanager.baidu.json.Token specialToken;
     ...
     */
    public static com.liangxunwang.unimanager.baidu.json.Token newToken(int ofKind, String image) {
        switch (ofKind) {
        default:
            return new com.liangxunwang.unimanager.baidu.json.Token(ofKind, image);
        }
    }

    public static com.liangxunwang.unimanager.baidu.json.Token newToken(int ofKind) {
        return newToken(ofKind, null);
    }

}
/*
 * JavaCC - OriginalChecksum=7284b9b54bb57ff6a0bcee36eb2945ba (do not edit this
 * line)
 */
