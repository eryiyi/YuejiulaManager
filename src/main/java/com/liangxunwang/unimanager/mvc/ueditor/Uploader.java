...
public class Uploader {
	...
	public Uploader(HttpServletRequest request, MultipartFile file) {
...
//		}
		...
		try {
			...
			if (!this.checkFileType(file.getOriginalFilename())) {
            ...
            file.transferTo(new File(this.getPhysicalPath(this.url)));
